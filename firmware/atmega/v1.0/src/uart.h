...
/**
 * The type for a uart callback function pointer.
 *
*/
typedef void (*uart_callback_t)(void);

/**
 * Configures the UART baudrate, interrupts and Registers an RX callback. The callback triggers every time a new byte is received.
 *
